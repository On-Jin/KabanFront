...
export default function NavBar(props: Props) {
    ...
    async function callApiDidi() {
        const response = await fetch("https://api.kaban.ntoniolo.com/discord-login", {
            method: "GET",
            headers: {
        ...
        <menu className="flex justify-between px-4 py-4
            ...
            <div className="flex space-x-4 justify-items-center items-center ">
                <li>
                    ...
                    {!avatar &&
                        <a
                            href={process.env.NODE_ENV == "development" ? `http://localhost:5264/discord-login` : `https://api.kaban.ntoniolo.com/discord-login`}>
