        ...
        <menu className="flex justify-between px-4 py-4
            ...
            <div className="flex space-x-4 justify-items-center items-center ">
                <li
                    // onClick={callApiDidi}
                >
                    <button onClick={callApiDidi}>xxx</button>
                    {avatar && avatar}
                    {!avatar &&
                        <Link href={process.env.NODE_ENV == "development" ? `http://localhost:5264/discord-login` : `https://api.kaban.ntoniolo.wtf/discord-login`}>
